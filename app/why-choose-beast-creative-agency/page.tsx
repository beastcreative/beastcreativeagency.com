  ...
  return (
    <>
      <section style={{ background: '#0c0c0c', padding: '100px 0 60px', borderBottom: '1px solid #1a1a1a' }}>
        <div className="container">
          <div style={{ maxWidth: '700px' }}>
            ...
            <h1 style={{ color: '#fff', fontFamily: 'var(--font-geist, sans-serif)', fontWeight: 700, fontSize: 'clamp(32px, 5vw, 56px)', textTransform: 'uppercase', lineHeight: 1.1, marginBottom: '24px' }}>
              Why Choose Beast Creative Agency?
            </h1>
            <p style={{ color: '#aaa', fontFamily: 'var(--font-geist, sans-serif)', fontSize: '18px', lineHeight: '1.7', marginBottom: '40px' }}>
      ...
      <div style={{ marginBottom: '60px' }}>
        <h2 style={{ color: '#fff', fontFamily: 'var(--font-geist, sans-serif)', fontWeight: 700, fontSize: 'clamp(24px, 3vw, 36px)', textTransform: 'uppercase', marginBottom: '20px' }}>
          Why choose the Best Digital Marketers in San Antonio?
        </h2>
        <p style={{ color: '#aaa', fontFamily: 'var(--font-geist, sans-serif)', fontSize: '17px', lineHeight: '1.8', maxWidth: '760px' }}>
          ...
          <div style={{ background: '#1a1a1a', border: '1px solid #333', borderRadius: '8px', padding: '48px', textAlign: 'center', marginTop: '60px' }}>
            <h2 style={{ color: '#fff', fontFamily: 'var(--font-geist, sans-serif)', fontWeight: 700, fontSize: '32px', textTransform: 'uppercase', marginBottom: '16px' }}>Ready to Work With Beast?</h2>
            <p style={{ color: '#aaa', fontFamily: 'var(--font-geist, sans-serif)', fontSize: '17px', marginBottom: '32px' }}>Let&apos;s talk about what we can build together.</p>
