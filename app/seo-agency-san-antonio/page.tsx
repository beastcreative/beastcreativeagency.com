...
export default function Page() {
  return (
    <>
      ...
      <div style={{ marginBottom: '60px' }}>
        <h2 style={{ color: 'var(--text)', fontFamily: 'var(--font-geist, sans-serif)', fontWeight: 700, fontSize: 'clamp(24px, 3vw, 36px)', textTransform: 'uppercase', marginBottom: '20px' }}>
          Drive Online Success with Expert SEO San Antonio Services
        </h2>
        <p style={{ color: 'var(--text-secondary)', fontFamily: 'var(--font-geist, sans-serif)', fontSize: '17px', lineHeight: '1.8', maxWidth: '760px' }}>
          Investing in professional SEO San Antonio services is crucial for businesses looking to enhance their online presence. Our tailored approach ensures that your website ranks higher on search engines, leading to increased visibility and higher conversions. By optimizing content, improving technical SEO, and refining user experience, we help businesses achieve long-term growth in competitive markets.
        </p>
      </div>
      <div style={{ marginBottom: '60px' }}>
        <h2 style={{ color: 'var(--text)', fontFamily: 'var(--font-geist, sans-serif)', fontWeight: 700, fontSize: 'clamp(24px, 3vw, 36px)', textTransform: 'uppercase', marginBottom: '20px' }}>
